## bagger (noetic) - 0.1.5-2

The packages in the `bagger` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic bagger` on `Tue, 02 Jan 2024 16:07:24 -0000`
...
## bagger (kinetic) - 0.1.4-1

The packages in the `bagger` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release bagger --rosdistro kinetic` on `Mon, 26 Apr 2021 20:36:00 -0000`
...
## bagger (noetic) - 0.1.3-3

The packages in the `bagger` repository were released into the `noetic` distro by running `/usr/bin/bloom-release bagger --track noetic --rosdistro noetic --new-track` on `Fri, 13 Nov 2020 19:16:31 -0000`
